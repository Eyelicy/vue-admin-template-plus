    ...
    children: [
        {
            ...
            path: '/app/dashboard',
            meta: { title: '首页', icon: 'tabler:dashboard' },
            component: () => import('@/pages/app/dashboard/index.vue'),
        },
        {
            name: 'order',
            path: '/app/order',
            meta: { title: '订单管理', icon: 'gg:menu-round' },
            children: [
                {
                    path: 'my-order',
                    meta: { title: '我的订单' },
        ...
        //                             component: () =>
        //                                 import(
        //                                     '@/pages/app/test-menu/level1-1/level2-1/level3-1.vue'
        //                                 ),
        //                         },
        //                         {
        //                             meta: { title: '三级菜单2' },
        ...
        //                             component: () =>
        //                                 import(
        //                                     '@/pages/app/test-menu/level1-1/level2-1/level3-2.vue'
        //                                 ),
        //                         },
        //                     ],
        //                 },
        ...
        //                             meta: { title: '三级菜单3' },
        //                             component: () =>
        //                                 import('@/pages/app/test-menu/level1-1/level2-2/index.vue'),
        //                         },
        //                     ],
        //                 },
        //             ],
        ...
        //                             meta: { title: '三级菜单4' },
        //                             component: () =>
        //                                 import('@/pages/app/test-menu/level1-2/level2-3/index.vue'),
        //                         },
        //                     ],
        //                 },
        //             ],
